    ...
    <Layout>
      <div className="about">
        ...
        <p>
          ...
          into the coding world. After the bootcamp I found a position where the
          focus was on managing the technical support for the german speaking
          users, structuring their needs and wishes and training and presenting
          the services to new users. It was a great experience as I got the
          chance to learn many new things but I was missing the coding! Then in
          early 2022 I quit that position and started to focus 100% in
          practicing my coding skills. Since then I have worked on various
          projects and websites. Focusing on technologies like HTML, CSS,
          JavaScript, React, using Apis, Firebase and GatsbyJS.
        </p>
        <p>
